...
from DevuMusic import BOT_ID, BOT_USERNAME, app, app2, devudb, pytgcalls
from DevuMusic.Helpers import _clear_, buttons, gen_thumb
...
async def on_stream_end(pytgcalls, update: Update):
    ...
    if not get:
        ...
        await app.send_photo(
            ...
            f"‣ **Title:** [{title[:27]}](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n"
